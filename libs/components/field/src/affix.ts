 ...
 * swojego slotu, a dekoracja bierna nie mogła być większa (`wym-real-34`).
 *
 * Przycisk `inset` bierz o stopień mniejszy od pola: wysokości obu są w tej
 * samej wielkości równe (`wym-api-18`), więc przycisk tej samej wielkości nie
 ...
 * jest ona równa wysokości pola tej samej wielkości (`wym-api-18`), rząd rósłby
