...
**Status:** przyjęta
**Realizuje:** [`wym-projekt-pliki`](../wymagania/projekt.md#wym-projekt-pliki),
[`wym-api-nazwy`](../wymagania/api.md#wym-api-nazwy)
...
- Style komponentu są plikiem SCSS, więc podlegają tym samym regułom lintu co reszta
  ([`wym-token-logiczne`](../wymagania/tokeny.md#wym-token-logiczne)).
