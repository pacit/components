...
**Status:** przyjęta
**Realizuje:** [`wym-api-teksty`](../wymagania/api.md#wym-api-teksty)
**Dowód:** [`lekcja-54`](../lekcje.md#lekcja-54) — celowa regresja: przy odczycie
z konstrukcji przełączenie języka daje `expected 'Select…' to be 'Wybierz…'`

## Kontekst

[Decyzja 0007](0007-konfiguracja-i-teksty.md) zostawiła jedno pytanie otwarte i sama
...
nie ogląda w diffie jako „odczytu" ([`lekcja-54`](../lekcje.md#lekcja-54)).
