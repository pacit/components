...
| Części w inwentarzu                     | brak — luka: inwentarza nie ma ([`wym-api-czesci`](../wymagania/api.md#wym-api-czesci))                                                                                                       |
| Tokeny + `contrast.policy.json`         | `libs/tokens/src/contrast.policy.json`, `libs/tokens/build.mjs`                                                                                                                               |
| Napisy przez `PCT_TEXTS`                | nie dotyczy — komponent nie wypisuje własnych napisów                                                                                                                                         |
