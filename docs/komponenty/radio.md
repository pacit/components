...
| Części w inwentarzu             | `libs/components/czesci.snapshot.md`, `tools/check-parts.mjs` (target `check-parts`). Uwaga: `label` kolidował z etykietami opcji — stąd przedrostek `group-` ([`lekcja-15`](../lekcje.md#lekcja-15))            |
