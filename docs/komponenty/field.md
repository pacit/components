...
| **Części**      | `field-header`, `field-label`, `field-label-aux`, `field-row`, `field-prefix`, `field-control`, `field-suffix`, `field-footer`, `field-hint`, `field-error`, `field-message-aux` |
...
| Części w inwentarzu             | brak — luka. **11 części, a wymaganie wymieniało 7** do 2026-07-27 — modelowy przykład tego, po co inwentarz ma być generowany |
