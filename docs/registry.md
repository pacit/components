...
| [`req-quality-coverage`](requirements/quality.md#req-quality-coverage)                 | ✅ enforced | in three parts, because the percentage, its denominator and the templ… | `tools/check-coverage.fixtures/` — twenty-one doctored inputs, one pe… |
