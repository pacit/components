...
| [`req-quality-coverage`](requirements/quality.md#req-quality-coverage)                 | ✅ enforced | in three parts, because the percentage, its denominator and the templ… | `tools/check-coverage.fixtures/` — eighteen doctored inputs, one per … |
