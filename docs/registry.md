...
| [`req-quality-coverage`](requirements/quality.md#req-quality-coverage)                 | ✅ enforced | in three parts, because the percentage, its denominator and the templ… | `tools/check-coverage.fixtures/` — thirteen doctored inputs, one per … |
...
| [`lesson-237`](lessons.md#lesson-237) | — _(not cited)_                                                                                                                                                   |
