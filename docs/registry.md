...
| [`req-quality-unit`](requirements/quality.md#req-quality-unit)                         | ✅ enforced | in three parts, because "the tests run", "how many pass" and "how man… | `tools/check-mutation.fixtures/` — 55 doctored inputs on a fake libra… |
