...
**Status:** przyjęta
**Realizuje:** [`req-api-number`](../requirements/api.md#req-api-number)
**Dowód:** [`lesson-32`](../lessons.md#lesson-32)

## Kontekst

[`req-api-platform`](../requirements/api.md#req-api-platform) mówi: nie implementujemy
...
wartość wyjściową i drugie nie miało skutku ([`lesson-32`](../lessons.md#lesson-32)).
...
- **Parsowanie szersze niż formatowanie to duża przestrzeń wejść.** To główny kandydat na
  ...
  ma i jest to zapisana luka w [`req-api-number`](../requirements/api.md#req-api-number).
