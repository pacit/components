...
| [0050](0050-a-skeleton-is-a-picture-of-a-wait.md)                               | A skeleton is a picture of a wait, and the wait belongs to the region                      | `req-a11y-built-in`, `req-api-platform`, `req-a11y-forced-colors`, `req-a11y-motion`, `req-token-logical`                   |
