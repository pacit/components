...
| A screen-reader test log                                   | none — gap: the same one every component here has. The question for the log: what NVDA and VoiceOver say on entering the row (the count), and what they say the moment after a removal, when focus has landed on the next cross                                                                                                                                                                                                                                                      |
| A docs page with live examples                             | `apps/sandbox/src/app/views/chips/` (the sandbox view). The published site: `/components/chips` — prerendered, the demo's own source is the code tab (2.1.7)                                                                                                                                                                                                                                                                                                                         |
