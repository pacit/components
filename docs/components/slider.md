...
| Screen-reader log               | Read 2026-09-16 from `docs/acr/at/` — three readers, whole sandbox, and **`aria-valuetext` is confirmed on all three rather than on chromium tree alone**. The formatted slider is announced `Discount · slider · 15 % · 0 percent.` (Orca), `Discount, slider, 15 percent` (NVDA), `15 % Discount slider` (VoiceOver); the one whose value is a word gives `Size · slider · Medium`, `Size, slider, Medium`, `Medium Size slider`. Orca alone adds a raw percentage of its own beside the text, which is its habit and not this component |
| docs page                       | `/components/slider` on the published site — prerendered, the demo's own source is the code tab                                                                                                                                                                                                                                                                                                                                                                                                                                            |
