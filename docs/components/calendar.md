...
| Screen-reader log               | Read 2026-09-16 from `docs/acr/at/` — three readers, whole sandbox, and **this component is not in them**. It is reached through the date toggle, which the walk announces as `Choisir une date · collapsed button. · opens dialog` and never presses: a Tab walk cannot enter a panel that opens on a key. What a reader says on a month grid — the cell names, the moving focus, the month change — needs a pass that ACTS, and that is the whole of what is left here |
| docs page                       | `/components/calendar` on the published site — prerendered, the demo's own source is the code tab                                                                                                                                                                                                                                                                                                                                                                        |
