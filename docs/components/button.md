...
klawiatury ([`req-api-platform`](../requirements/api.md#req-api-platform))
...
realizacja [`req-api-platform`](../requirements/api.md#req-api-platform), nie przeoczenie.
...
| `prefers-reduced-motion`                | `apps/sandbox-e2e/src/preferences.spec.ts` — spinner **zwalnia**, nie staje ([0008](../decisions/0008-motion-axis.md))                                                                         |
...
| Oś gęstości                             | brak — luka: [`req-token-density`](../requirements/tokens.md#req-token-density) nie istnieje w źródłach DTCG                                                                                   |
| RTL                                     | brak — luka: [`req-token-logical`](../requirements/tokens.md#req-token-logical) nie ma bramki. Uwaga: spinner ma `border-right-color`, czyli jedno z dwóch RTL-bezpiecznych trafień fizycznych |
...
| Budżet rozmiaru entrypointu             | brak — luka: budżetu nie ma ([`req-project-tree-shaking`](../requirements/project.md#req-project-tree-shaking))                                                                                |
...
- **Brak wariantu ikonowego** — przycisk z samą ikoną wymagałby kwadratowej geometrii
  i osobnej gwarancji obszaru dotyku. Czeka na [`req-api-icons`](../requirements/api.md#req-api-icons).
