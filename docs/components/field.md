...
|                 |                                                                                                                                                                                                                                                                                                     |
| --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Wartość**     | **nie implementuje kontraktu formularza** — robi to kontrolka w środku ([0003](../decisions/0003-wrapper-and-control.md))                                                                                                                                                                           |
...
| Napisy przez `PCT_TEXTS`        | `tools/check-texts.mjs` — wszystkie napisy pochodzą z inputów                                                                                                                                                                                                                                                                         |
...
[0003](../decisions/0003-wrapper-and-control.md) (główna),
...
- **Przycisk `inset` musi być o stopień mniejszy od pola.** W wielkości `sm` nie ma już
  ...
  wniosek z [0004](../decisions/0004-explicit-height.md), nie wada dopasowania.
