...
| Screen-reader log               | Read 2026-09-16 from `docs/acr/at/` — three readers, whole sandbox. **Half answered.** Every trigger announces that it opens a dialog, in all three: `start · collapsed button. · opens dialog` (Orca), `start, button, collapsed, opens dialog` (NVDA), `start dialog pop up button` (VoiceOver) — VoiceOver alone omits the collapsed state. What a reader announces when the non-modal dialog TAKES FOCUS is not here: the walk presses Tab and never opened one                                                                                                                                                     |
| docs page                       | `/components/popover` on the published site — prerendered, the demo's own source is the code tab                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
