...
| A docs page with live examples                             | `apps/sandbox/src/app/views/stepper/` (the sandbox view). The published site: `/components/stepper` — prerendered, the demo's own source is the code tab (2.1.7)                                                            |
