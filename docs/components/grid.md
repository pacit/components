...
| Entrypoint size budget                                     | `libs/components/size.snapshot.md` — `./grid` **673 B on `@angular/core` alone** — the smallest entrypoint in the package, because the whole component is one declaration                                                                                                                                              |
