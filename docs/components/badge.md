...
| A docs page with live examples                             | `apps/sandbox/src/app/views/badge/` (the sandbox view). The published site: `/components/badge` — prerendered, the demo's own source is the code tab (2.1.7)                                                                                    |
