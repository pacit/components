...
| Screen-reader log                                          | Read 2026-09-16 from `docs/acr/at/` — three readers, whole sandbox, and the argument is now measured rather than asserted: **`/layout` produced no stop of its own in any of the three logs**. Every stop there belongs to the sandbox scaffold — `Theme · panel · light · selected radio button.` and its two neighbours — so a container adds nothing a Tab walk can land on. It does not prove silence to a reader READING the page, which is a different pass, and no reader announced a box where one was drawn |
| A docs page with live examples                             | `apps/sandbox/src/app/views/layout/` (the sandbox view). The published site: `/components/container` — prerendered, the demo's own source is the code tab                                                                                                                                                                                                                                                                                                                                                            |
