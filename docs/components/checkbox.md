...
| Parts in the inventory          | `libs/components/czesci.snapshot.md`, `tools/check-parts.mjs` (target `check-parts`). Note: the `control` part collided with the native input once wrapped ([`lesson-24`](../lessons.md#lesson-24)) |
